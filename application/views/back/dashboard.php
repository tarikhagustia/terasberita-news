                                ...
                                <button class="btn btn-primary btn-block avatar-save" type="submit">Done</button>
                                  ...
                                  <!-- <div class="modal-footer">
                                      ...
                                      <ul class="list-unstyled user_data">
                                        <li><i class="fa fa-map-marker user-profile-icon"></i> Goalpara Indah, Sukabumi, Jawa Barat
                                        </li>
                                        ...
                                        <li class="m-top-xs">
                                          ...
                                          <a href="http://www.kimlabs.com/profile/" target="_blank">www.mugen.id</a>
                                        </li>
                                      </ul>

                                      <a class="btn btn-success" onclick="new PNotify({
                                  title: 'Masih Demo',
                                  text: 'Fitur ini masih demo',
                                  type: 'error',
                                  styling: 'bootstrap3'
