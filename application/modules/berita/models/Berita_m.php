...
class Berita_m extends CI_Model
{
  ...
  public function get_feed($category_id)
  {
    $this->db->select('news_url, fn_news.news_id, fn_category.category_id, news_title, news_thumb');
    ...
    $this->db->where('fn_category.category_id', $category_id);
