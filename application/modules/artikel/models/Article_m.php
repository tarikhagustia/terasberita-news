...
class Article_m extends CI_Model
{
  ...
  {
    $this->db->select('fn_news.news_id, news_creator, caption, category_alias, fn_category.category_id, news_title, news_desc, news_thumb, news_timestamp, bo_user.`full_name` , news_views')
    ->from('fn_news')
