...
$(document).ready(function() {
    ...
    $SIDEBAR_MENU.find('a').on('click', function(ev) {
        var $li = $(this).parent();
        var $cek = $li.parent();
        // console.log($cek.find('.active').html())
        ...
        if ($li.is('.active')) {
            ...
            $cek.find('.active').removeClass('active');
            $SIDEBAR_MENU.find('.mm_menuitem').removeClass('active');
            if (!$li.parent().is('.child_menu')) {
                // console.log('bukan bapak')
